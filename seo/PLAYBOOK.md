...
- [~] JEFF: Optimize the existing Google Business Profile — profile strength shows "Complete info" still outstanding, but 2026-09-10 finding: that banner mixes real free fields (description, services, hours, attributes, photos, posts) with paid upsells (Google Ads credit, `@playingwithphoto.com` Workspace email) — Jeff should fill the free fields only, skip the upsells. Reviews: Jeff asked recent clients 2026-09-06ish, **2 new 5-star reviews came in by 2026-09-10** (Christine Chew — wedding; a second reviewer — corporate/Teacher's Day superhero-themed event) — replies drafted in-session, Jeff to post via the GBP dashboard "Reply" button. Review count climbing from the 1 flagged in iteration 7. NEXT: confirm replies posted, keep tracking review count.
- [ ] GBP Posts queue — 5 drafts + 2 review replies in `seo/gbp-posts-queue.md`, none posted yet as of 2026-09-10. Jeff to publish via business.google.com → Posts, roughly one every 1-2 weeks (GBP posts fade after ~7 days), and post the review replies via the GBP dashboard's "Reply" button. Purpose is local-pack visibility/trust, not organic site ranking — doesn't replace the website SEO work. NEXT iteration: check the queue file's checkboxes for what's posted, draft fresh ones once it's used up.
